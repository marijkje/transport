...
/**
 *  Passes in login.jsp retrieved user information to Admin class 
 *  allowed method to compare userinfo with registered 'admin' users
            ...
            ServletException 
    {
        ...
        if (name!=null)
        {
            try {
                ...
                if (adm.isAllowed(name, pass, "admin"))
                {
